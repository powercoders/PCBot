...
public class OverrideClassAdapter extends ClassAdapter {
	...
	static class MethodAdapter implements MethodVisitor {
		...
		MethodAdapter(final MethodVisitor delegate, final String old_clazz,
	...
	public OverrideClassAdapter(final ClassVisitor delegate,
			final String old_clazz, final String new_clazz) {
		super(delegate);
		this.old_clazz = old_clazz;
		this.new_clazz = new_clazz;
	}
