 ...
 * @author CCSki
 */
public class Messages_sv extends Messages {

	public Messages_sv() {
		super();
	}

	public final String LANGUAGE = "Svenska";

	public final String FILE = "Arkiv";
	...
	public final String FORCEINPUT = "Tvinga inmatning";
	...
	public final String SITE = "Hemsida";
	public final String PROJECT = "Projekt";
	public final String ABOUT = "Om oss";
