...
public class Messages_de extends Messages {
	...
	public final String LANGUAGE = "Deutsch";

	public final String FILE = "Datei";
	public final String EDIT = "Bearbeiten";
	public final String VIEW = "Ansicht";
	public final String TOOLS = "Werkzeuge";
	public final String HELP = "Hilfe";

	public final String NEWBOT = "Neuer Bot";
	public final String CLOSEBOT = "Bot schließen";
	public final String HIDEBOT = "Ausblenden";
	public final String ADDSCRIPT = "Script hinzufügen";
	public final String RUNSCRIPT = "Script ausführen";
	...
	public final String DISABLEANTIRANDOMS = "Zufälle deaktivieren";
	public final String DISABLEAUTOLOGIN = "Login deaktivieren";
	public final String DISABLEADS = "Werbung deaktivieren";
	public final String DISABLECONFIRMATIONS = "Bestätigungen deaktivieren";
	...
	public final String HIDETOOLBAR = "Toolbar verstecken";
	public final String HIDELOGPANE = "Log-Panel verstecken";
	public final String ALLDEBUGGING = "Alle Debugging-nachrichten";

	public final String CLEARCACHE = "Cache Leeren";
	public final String OPTIONS = "Optionen";

	public final String SITE = "Site";
	public final String PROJECT = "Projekt";
	public final String ABOUT = "Über";
