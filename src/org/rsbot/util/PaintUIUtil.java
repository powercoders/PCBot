...
public class PaintUIUtil {
	...
	public PaintUIUtil(Graphics render) {
	...
	public void drawCheckBox(final Rectangle boxRect, final String text,
		...
		g2.drawString(text, boxRect.x + boxRect.width + 3, boxRect.y
				+ boxRect.height - 2);
		g2.setColor(Color.black);
		if (checked) {
			g2.drawLine(boxRect.x, boxRect.y, boxRect.x + boxRect.width,
					boxRect.y + boxRect.height);
			g2.drawLine(boxRect.x + boxRect.width, boxRect.y, boxRect.x,
					boxRect.y + boxRect.height);
		}
