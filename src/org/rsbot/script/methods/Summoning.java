...
public class Summoning extends MethodProvider {
	...
	public static enum Familiar {
		...
		SPIRIT_WOLF("Spirit Wolf", 1, 6, 3, "Howl", 0), DREADFOWL("Dreadfowl",
				...
				36, 3, "Petrifying Gaze", 0), SPIRIT_GUTHATRICE(
				"Spirit guthatrice", 43, 36, 3, "Petrifying Gaze", 0), SPIRIT_SARATRICE(
				"Spirit saratrice", 43, 36, 3, "Petrifying Gaze", 0), SPIRIT_ZAMATRICE(
				"Spirit zamatrice", 43, 36, 3, "Petrifying Gaze", 0), SPIRIT_PENGATRICE(
				"Spirit pengatrice", 43, 36, 3, "Petrifying Gaze", 0), SPIRIT_CORAXATRICE(
				"Spirit coraxatrice", 43, 36, 3, "Petrifying Gaze", 0), SPIRIT_VULATRICE(
				"Spirit vulatrice", 43, 36, 3, "Petrifying Gaze", 0), IRON_MINOTAUR(
				"Iron minotaur", 46, 37, 6, "Iron Bull Rush", 0), PYRELORD(
				"Pyrelord", 46, 32, 6, "Immense Heat", 0), MAGPIE("Magpie", 47,
				34, 12, "Thieving Fingers", 0), BLOATED_LEECH("Bloated leech",
				49, 34, 6, "Blood Drain", 0), SPIRIT_TERRORBIRD(
				"Spirit terrorbird", 52, 36, 8, "Tireless Run", 12), ABYSSAL_PARASITE(
