...
public class PaintStyleSheet {
	...
	public static final Map<Class<?>, PaintStyleSheet> defaultHoverStyles = new HashMap<Class<?>, PaintStyleSheet>();
	static {
		final PaintStyleSheet textField = new PaintStyleSheet();
		...
		final PaintStyleSheet buttonStyle = new PaintStyleSheet();
		...
		final PaintStyleSheet buttonHoverStyle = buttonStyle.clone();
	...
	public PaintStyleSheet clone() {
		final PaintStyleSheet s = new PaintStyleSheet();
		s.bgColor = bgColor;
		s.fgColor = fgColor;
		s.font = font;
		s.border = border;
