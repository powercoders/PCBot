...
public class RSGroundItem extends MethodProvider {
	...
	public RSGroundItem(final MethodContext ctx, final RSTile location,
			final RSItem groundItem) {
		super(ctx);
	...
	public boolean doAction(final String action, final String option) {
		...
		return methods.tiles.doAction(getLocation(), random(0.45, 0.55), random(0.45, 0.55), 0, action, option);
	}
